export const invite = {
    ...
    event: {
        ...
        mapsUrl: "https://maps.app.goo.gl/K4fihCHNPv52Ez6r5", // pega aquí el link real
    },
    music: {
        videoId: "sD9_l3oDOag",
        startSeconds: 18,
    ...
    gifts: {
        ...
        options: [
        // { icon: "🏡", title: "Un ladrillo para nuestra casa", amount: 50000 },
        // { icon: "🔨", title: "Un metro de construcción", amount: 80000 },
        // { icon: "🌙", title: "Una noche de descanso para los novios", amount: 100000 },
        // { icon: "🍷", title: "Una cena especial", amount: 150000 },
        // { icon: "🙏", title: "Aporte para nuestro matrimonio por la iglesia", amount: 200000 },
    ...
    rsvp: {
        deadlineText: "Por favor confirma tu asistencia por el mismo medio que recibiste esta invitacion.",
        // buttonText: "Confirmar asistencia",
        url: "", // pega aquí WhatsApp o Google Form
    },
    ...
    access: {
        ...
        // videoStandby: "Próximamente compartiremos un video explicativo del acceso y estacionamientos.",
    },
    ...
    gallery: {
        ...
        photos: [
            { src: "/galeria/1.jpg", alt: "Retrato 1" },
            { src: "/galeria/2.jpg", alt: "Retrato 2" },
            { src: "/galeria/3.jpg", alt: "Retrato 3" },
            // { src: "/galeria/4.jpg", alt: "Retrato 4" },
            // { src: "/galeria/5.jpg", alt: "Retrato 5" },
            { src: "/galeria/6.jpg", alt: "Retrato 6" },
            { src: "/galeria/7.jpg", alt: "Retrato 7" },
            { src: "/galeria/8.jpg", alt: "Retrato 8" },
            { src: "/galeria/9.jpg", alt: "Retrato 9" },
            // { src: "/galeria/10.jpg", alt: "Retrato 10" },
            { src: "/galeria/11.jpg", alt: "Retrato 11" },
            // { src: "/galeria/12.jpg", alt: "Retrato 12" },
            // { src: "/galeria/13.jpg", alt: "Retrato 13" },
        ],
        },
